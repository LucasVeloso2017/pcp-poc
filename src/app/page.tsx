...
export default function Home() {
  ...
  const { municipios, errorAllMunicipios, isLoadingAllMunicipios } = useAllMunicipios();

  return (
    <div className='w-full bg-white'>
      <div
        className='w-full h-auto bg-cover bg-right bg-no-repeat flex justify-center'
        style={{
          backgroundImage: `url(/img/bg-hero-pcp.png)`,
          backgroundPosition: '78% center',
        }}
      >
        <div className='w-[80%] pt-48'>
          <div className='w-[90%] flex flex-col'>
            <h1 className='font-dm-sans text-[40px] leading-[130%] font-bold text-[#081E2D] text-wrap'>
            ...
            <p className='font-dm-sans font-normal text-[18px] leading-[150%] text-[#333333]'>
              ...
              social para que gestores públicos, fornecedores e sociedade
              avancem juntos.
            </p>
            <br />
            ...
            <div className='w-full h-auto'>
              <AdvancedFilters
                ...
                municipios={{ municipios, errorAllMunicipios, isLoadingAllMunicipios }}
              />
            </div>
            <div className='mt-15 w-full flex flex-wrap items-center gap-5 pb-15'>
              <Button
      ...
      <div className='w-full flex justify-center py-15'>
        <div className='w-[80%] flex flex-col items-center justify-center'>
          <h1 className='font-dm-sans font-bold text-[48px] text-[#1A1A1A] text-wrap'>
            Nossas Soluções
          </h1>
          <h4 className='font-inter font-normal text-lg text-[#555555] text-wrap'>
            Plataforma completa para todas as necessidades de compras públicas
          </h4>

          <div className='w-full flex flex-wrap items-center justify-between mt-18'>
          ...
          <div className='w-full flex flex-wrap items-center justify-between mt-18'>
            <div className='flex flex-col items-center justify-center'>
              ...
              <h3 className='mt-1.5 mb-3 font-inter font-bold text-[16px] text-[#1A1A1A]'>
                Produtos Cadastrados
              </h3>
              <p className='font-inter font-normal text-[11px] text-[#777777]'>
                E em crescimento constante com base CATMAT
              </p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <h1 className='font-dm-sans font-bold text-[48px] text-[#1AB0C3]'>
              ...
              <p className='font-inter font-normal text-[11px] text-[#777777]'>
                mais rápido que licitação tradicional
              </p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <h1 className='font-dm-sans font-bold text-[48px] text-[#1AB0C3]'>
              ...
              <p className='font-inter font-normal text-[11px] text-[#777777]'>
                vs. 90-120 dias no modelo tradicional
              </p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <h1 className='font-dm-sans font-bold text-[48px] text-[#1AB0C3]'>
              ...
              <p className='font-inter font-normal text-[11px] text-[#777777]'>
                Orgãos públicos, Estatais, Sistema S entre outros
              </p>
            </div>
          </div>
        </div>
      ...
      <div className='w-full flex justify-center py-15'>
        <div className='w-[80%] flex flex-col gap-5 items-center justify-center'>
          <h1 className='font-dm-sans font-bold text-[48px] text-[#1A1A1A]'>
            Como Funciona
          </h1>
          <h4 className='font-inter font-normal text-lg text-[#555555] mb-16'>
            Um processo transparente e eficiente que garante a melhor aplicação
            dos recursos públicos
          </h4>
          <Etapas usaBackground={true} etapas={etapas} usaIndex={true} />
          <div className='w-full h-auto p-4 flex items-center justify-center flex-col bg-white border border-[#E5E5E5] rounded-2xl mt-12'>
            <h1 className='font-dm-sans font-bold text-[24px] text-[#111827] text-wrap'>
              Quer participar dos processos?
            </h1>
            <h4 className='font-inter font-normal text-[14px] text-[#6B7280] text-wrap'>
              Saiba como vender para os entes públicos e participar do novo
              conceito de Compras Públicas
            </h4>
      ...
      <div className='w-full flex justify-center py-15 bg-white'>
        <div className='w-[80%] flex flex-col items-center justify-center'>
          ...
          <h4 className='font-inter font-normal text-lg text-[#555555] mb-16'>
            Os maiores processos de compras em execução ou recém-finalizados,
            com total transparência para a sociedade
          </h4>

          <div className='w-full flex flex-wrap md:flex-wrap lg:flex-nowrap xl:flex-nowrap sm:max-md:flex-wrap   items-center justify-center gap-4'>
            <BuyCard />
            <BuyCard />
            <BuyCard />
      ...
      <div className='w-full flex justify-center py-15 bg-[#E9F8F9]'>
        <div className='w-[80%] flex flex-col items-center justify-center'>
          <div className='w-full h-auto bg-white rounded-2xl flex flex-col justify-center items-center gap-8 p-6 shadow-[0px_3px_6px_0px_#4546461A]'>
            <h1 className='font-inter font-semibold text-center text-[40px] text-[#333333]'>
              Perguntas frequentes
            </h1>
            <div className='w-full p-6 flex items-center justify-between border-b border-[#D4D4D4] rounded-2xl cursor-pointer'>
              <span className='font-dm-sans font-medium text-[18px] leading-[120%] text-[#181A1F]'>
